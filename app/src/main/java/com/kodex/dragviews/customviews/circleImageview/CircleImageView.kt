package com.kodex.dragviews.customviews.circleImageview
...
//        mBitmapPaint = mBitmapPaint ?: Paint()
        canvas.drawCircle(
    ...
    fun setCircleBackgroundColorResource(@ColorRes circleBackgroundRes: Int) {
        circleBackgroundColor = context.resources.getColor(circleBackgroundRes, null)
    }
